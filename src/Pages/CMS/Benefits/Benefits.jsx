    ...
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(75, 0, 130, 0.1) 0%, rgba(75, 0, 130, 0) 70%)",
          zIndex: 0,
          animation: `${float} 8s ease-in-out infinite`,
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(138, 43, 226, 0.1) 0%, rgba(138, 43, 226, 0) 70%)",
          zIndex: 0,
          animation: `${float} 10s ease-in-out infinite`,
          animationDelay: "1s",
          display: { xs: "none", sm: "block" },
            ...
            <Paper
              ...
              sx={{
                ...
                "&:hover": {
                  ...
                  boxShadow: {
                    xs: "0 10px 30px rgba(75, 0, 130, 0.15)",
                    sm: "0 15px 40px rgba(75, 0, 130, 0.2)",
                  },
                },
              }}
            >
            ...
            {[
              {
                title: "Sacred Movement",
                description:
                  "Honor your body through asanas that build strength, flexibility and grace.",
              },
              {
                title: "Mindful Awareness",
                description:
                  "Cultivate present-moment awareness through conscious breathing techniques.",
              },
              {
                title: "Emotional Harmony",
                description:
                  "Release stored tension and create space for peace and contentment.",
              },
              {
                title: "Spiritual Connection",
                description:
                  "Deepen your relationship with your true essence and universal energy.",
              },
              {
                title: "Energetic Alignment",
                description:
                  "Balance your chakras and awaken your vital life force energy (prana).",
              },
            ].map((benefit, index) => (
              <Reveal
                key={index}
                ...
                <Paper
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      ...
                      boxShadow: {
                        xs: "none",
                        sm: "0 8px 25px rgba(138, 43, 226, 0.15)",
                      },
                      borderLeft: {
                        xs: "4px solid #8a2be2",
                        sm: "4px solid #4b0082",
