...
export default function Branches() {
  ...
  return (
    <MainContainer initial="hidden" animate="visible" variants={containerVariants}>
      <SectionTitle variant="h2" component="h2" gutterBottom variants={itemVariants}>
        Our Branches
      </SectionTitle>
      ...
      {data.map((list, index) => (
        ...
        >
          <GradientAccordionSummary
            expandIcon={<ExpandMoreIcon style={{ color: "white", fontSize: "1.8rem" }} />}
            aria-controls={`panel${index}-content`}
            id={`panel${index}-header`}
          >
            <BranchName variant="h6" component="h3">
          ...
          <GradientAccordionDetails>
            <AddressText>
              <LocationOnIcon color="primary" fontSize="small" sx={{ marginRight: "8px", color: "#6E45E2" }} />
              <Box>
                <strong>Address:</strong> {list.Add}
              </Box>
            </AddressText>
